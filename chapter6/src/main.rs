...
fn main() {
    ...
    // date_time_type::format();           // 日時のフォーマット
    ...
    // vec_type::sort();                   // 要素のソート
    // linked_list_type::instantiate();    // インスタンスの生成
    ...
    // hash_set_type::instantiate();       // インスタンスの生成
